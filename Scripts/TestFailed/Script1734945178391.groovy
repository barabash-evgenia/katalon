...
Mobile.startApplication('C:\\Users\\Evgenia\\Downloads\\Calculator_8.6.1 (625857114)_APKPure.apk', true)
...
String actualValue = Mobile.getText(findTestObject('Object Repository/android.widget.TextView - 6'), 0)

assert expectedValue == actualValue : "Test failed! Expected: " + expectedValue + ", but got: " + actualValue
